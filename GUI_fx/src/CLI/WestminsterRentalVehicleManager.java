...
public class WestminsterRentalVehicleManager implements RentalvehicleManager
{
    ...
    public void viewVehicle(){
        ...
        if(vehicleType.equals("car")){
            for (int i = 0; i < vehicleList.size(); i++) {
                pno = vehicleList.get(i).getPlateNo();
    ...
    private void TextReaderBike() {
        try{
            ...
            while (rs3.next()) {
                ...
                newBike.setPlateNo(rs3.getString("PlateNo"));
                newBike.setMake(rs3.getString("Make"));
                newBike.setEngineCapacity(rs3.getInt("EngineCapacity"));
                newBike.setPrice(rs3.getLong("Price"));
                newBike.setTopSpeed(rs3.getInt("TopSpeed"));
                newBike.setFuelCapacity(rs3.getInt("FuelCapacity"));
                newBike.setSeatCapacity(rs3.getInt("SeatCapacity"));
                newBike.setBikeID(rs3.getInt("bikeID"));
                newBike.setNoOfHelmets(rs3.getInt("noofHelmets"));
    ...
    private void TextReadCar(){
        try{
            ...
            while(rs2.next()){
                Car carRead = new Car();
                carRead.setPlateNo(rs2.getString("PlateNo"));
                carRead.setMake(rs2.getString("Make"));
                carRead.setEngineCapacity(rs2.getInt("EngineCapacity"));
                carRead.setPrice(rs2.getLong("Price"));
                carRead.setTopSpeed(rs2.getInt("TopSpeed"));
                carRead.setFuelCapacity(rs2.getInt("FuelCapacity"));
                carRead.setSeatCapacity(rs2.getInt("SeatCapacity"));
                carRead.setNoofDoors(rs2.getInt("noOFDoors"));
                carRead.setWagon(rs2.getBoolean("isWagon"));
                carRead.setAirConditioned(rs2.getBoolean("isAirConditioned"));
                carRead.setCarID(rs2.getInt("carID"));
        ...
        try {
            ...
            for (int i = 0; i < vehicleList.size(); i++) {
                ...
                if(check.substring(0,1).equals("P")) {
                    String contquery2 = "INSERT INTO car (PlateNo,Make,EngineCapacity,SeatCapacity, Price, TopSpeed, FuelCapacity,noOFDoors,isWagon,isAirConditioned,carID)VALUES(?,?,?,?,?,?,?,?,?,?,?)";
                    ...
                    contpst2.setString(8, String.valueOf(vehicleList.get(i).getNoofDoors()));
                    ...
                    contpst2.setString(11, String.valueOf(vehicleList.get(i).getCarID()));
